...
public class AlertActivity extends AppCompatActivity {
    ...
    private Button btnBtnAlertWithOptions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBtnAlertWithOptions = findViewById(R.id.btn_alert_with_options);
        ...
        btnAlert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage("Esta es mi mensaje");
                builder.create().show();
            }
        });
        ...
        btnBtnAlertWithOptions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AlertActivity.this);
